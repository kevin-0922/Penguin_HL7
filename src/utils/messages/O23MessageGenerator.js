...
import { generateTQ1Segment } from '../segments/TQ1SegmentGenerator';
 ...
 */
export const generateO19Message = (formData) => {
  const segments = [];
  
  // 按照 HL7 OMI^O19 訊息格式順序生成段落
  ...
  segments.push(generateTQ1Segment(formData));
