...
export const generateMSHSegment = (formData) => {
  ...
  const segments = [
    ...
    mshData.countryCode || '',                // MSH-17: Country Code =
    mshData.characterSet || '',               // MSH-18: Character Set 
    mshData.principalLanguage || '',          // MSH-19: Principal Language 
    mshData.alternateCharacterSet || '',      // MSH-20: Alternate Character Set 
    mshData.messageProfileIdentifier || '',   // MSH-21: Message Profile Identifier 
  ];
